                    ...
                    <div class="rate-carousel-item rate-carousel-item--info-page tariff_{{ $tariff['id'] }} {{ !empty($tariff_info) && $tariff_info->id == $tariff['id']  ? "active_tariff" : "" }}">
                        ...
                        <div class="rate__footer">
                            <a href="{{ route('tariff.payment',['id'=>$tariff['id']]) }}"
                               class="btn btn-main-carousel btn-md btn-flat rate-carousel__button">Оформить подписку</a>
                            <a href="#"
            ...
            <div class="news__item about-tariff__item">
                ...
                <div class="col-xs-12 col-md-4">
                    <p class="tariff___ref-sys">
                        {{ isset($tariff_info->levels) ? $tariff_info->levels : "" }} уровня
                    </p>
                ...
                <div class="col-xs-12 col-md-4">
                    <p class="tariff___term">
                        {{ isset($tariff_info->term) ? $tariff_info->term : "" }}
                        дней
                    </p>
                    <h4>Срок действия</h4>
                </div>
