        ...
        <ul class="nav navbar-nav navbar-right top-main-menu__menu_right hidden-xs" >
            ...
            @if(Auth::check())
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->login }} <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li class="bottom-border"><a href="{{ route('cabinet') }}">@lang('messages.personal_area')</a></li>
                        <li class="no-top-border"><a href="{{ route('logout') }}">@lang('messages.exit')</a></li>
                    </ul>
                </li>
            @else
                <li><a href="{{ route('register') }}">@lang('messages.register')</a></li>
